...
class Operation(BaseOperation):
    ...
    def setup_parser(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            default=(
                "Ты — соискатель на HeadHunter. "
                "Твой текст отправляется работодателю НАПРЯМУЮ без проверки. "
        ...
        parser.add_argument(
            ...
            default=(
                "Напиши короткий ответ работодателю. "
                "Выведи ТОЛЬКО текст сообщения, ничего больше."
            ),
        )
